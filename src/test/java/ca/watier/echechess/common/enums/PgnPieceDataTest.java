...
import ca.watier.echechess.common.factories.PieceDataFactory;
...
public class PgnPieceDataTest {
    ...
    public void getParsedActionsTest() {
        Assertions.assertThat(PieceDataSection.getParsedActions("axb1=Q#")).contains(
    ...
    public void getParsedSingleMoveTest() {
        Assertions.assertThat(PieceSingleMoveSection.getParsedActions("Nge2")).
