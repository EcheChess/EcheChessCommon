...
public class MathUtilsTest {
    ...
    public void isPositionOnCirclePerimeter_knight() {
        ...
        Assert.assertTrue(MathUtils.isPositionOnCirclePerimeter(D_5, B4, x + KNIGHT_RADIUS_EQUATION, y));
        Assert.assertTrue(MathUtils.isPositionOnCirclePerimeter(D_5, B6, x + KNIGHT_RADIUS_EQUATION, y));

        Assert.assertTrue(MathUtils.isPositionOnCirclePerimeter(D_5, C7, x + KNIGHT_RADIUS_EQUATION, y));
        Assert.assertTrue(MathUtils.isPositionOnCirclePerimeter(D_5, E7, x + KNIGHT_RADIUS_EQUATION, y));

        Assert.assertTrue(MathUtils.isPositionOnCirclePerimeter(D_5, F4, x + KNIGHT_RADIUS_EQUATION, y));
        Assert.assertTrue(MathUtils.isPositionOnCirclePerimeter(D_5, F6, x + KNIGHT_RADIUS_EQUATION, y));

        Assert.assertTrue(MathUtils.isPositionOnCirclePerimeter(D_5, C3, x + KNIGHT_RADIUS_EQUATION, y));
        Assert.assertTrue(MathUtils.isPositionOnCirclePerimeter(D_5, E3, x + KNIGHT_RADIUS_EQUATION, y));

        Assert.assertFalse(MathUtils.isPositionOnCirclePerimeter(D_5, D7, x + KNIGHT_RADIUS_EQUATION, y));
        Assert.assertFalse(MathUtils.isPositionOnCirclePerimeter(D_5, D3, x + KNIGHT_RADIUS_EQUATION, y));
        Assert.assertFalse(MathUtils.isPositionOnCirclePerimeter(D_5, B5, x + KNIGHT_RADIUS_EQUATION, y));
        Assert.assertFalse(MathUtils.isPositionOnCirclePerimeter(D_5, F5, x + KNIGHT_RADIUS_EQUATION, y));
    }
